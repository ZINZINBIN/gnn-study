...
parser.add_argument("--save_path", type=str, default="./weights/gmm_best.pt")
parser.add_argument("--save_result", type=str,
                    default="./results/gmm_test_residual.png")
...
if __name__ == "__main__":
    ...
    plot_training_curve(train_loss, valid_loss, save_dir = "./results/gmm-training-curve.png")
    ...
    sample_submission.to_csv("./results/gmm_submission.csv", index=False)

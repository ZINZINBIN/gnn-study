...
parser.add_argument("--save_path", type=str, default="./weights/hgnn_best.pt")
parser.add_argument("--save_result", type=str,
                    default="./results/hgnn_test_residual.png")
...
if __name__ == "__main__":
    ...
    sample_submission.to_csv("./results/hgnn_submission.csv", index=False)

...
parser.add_argument("--save_path", type=str, default="./weights/graph_conv_best.pt")
...
if __name__ == "__main__":
    ...
    model.to(device)
    loss_fn_eval = torch.nn.L1Loss(reduction="sum")
    ...
    plot_training_curve(train_loss, valid_loss,
                        save_dir="./results/graph-conv-training-curve.png")
    ...
    sample_submission.to_csv("./results/graph_conv_submission.csv", index=False)

...
parser.add_argument("--num_epoch", type=int, default=240)
...
parser.add_argument("--save_path", type=str, default="./weights/chebnet_best.pt")
parser.add_argument("--save_result", type=str,
                    default="./results/chebnet_test_residual.png")
...
if __name__ == "__main__":
    ...
    plot_training_curve(train_loss, valid_loss, save_dir = "./results/chebnet-training-curve.png")
    ...
    sample_submission.to_csv("./results/chebnet_submission.csv", index=False)
